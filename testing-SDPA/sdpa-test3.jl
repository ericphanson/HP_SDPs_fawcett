...
solvers = [SDPASolver(Mode=PARAMETER_STABLE_BUT_SLOW)]

@info "Starting tests with mode PARAMETER_STABLE_BUT_SLOW"

@testset "Convex Mode=PARAMETER_STABLE_BUT_SLOW" begin
